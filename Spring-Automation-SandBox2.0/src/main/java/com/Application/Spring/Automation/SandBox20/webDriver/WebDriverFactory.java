package com.Application.Spring.Automation.SandBox20.webDriver;
...
public class WebDriverFactory {
    ...
    public static WebDriver getDriver() {
        if (THREAD_LOCAL_DRIVER.get() != null) {
            ...
            log.error("WebDriver is nul and it shouldn't be..");
            throw new RuntimeException("WebDriver is nul and it shouldn't be..");
        }
    }
    ...
    public static void createDriver() {
        ...
        if (Browser.CHROME.is(browserType)) {
            THREAD_LOCAL_DRIVER.set(createLocalChrome());
    ...
    private static WebDriver createLocalChrome() {
